...
class _PhoneRegisterPageState extends State<PhoneRegisterPage> {
  ...
  Future<void> _handleRegister() async {
    ...
    try {
      final result = await AuthApiService.registerWithPhone(phone);
      if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: const Text('手机号注册'), centerTitle: true),
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('创建你的账号', style: theme.textTheme.headlineLarge),
              const SizedBox(height: 8),
              Text(
                '目前为开发环境，将使用万能验证码 666666 完成注册。',
